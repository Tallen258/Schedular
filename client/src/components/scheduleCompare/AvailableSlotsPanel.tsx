            ...
            <>
              <div className="space-y-2">
                {availableSlots.map((slot, index) => (
                  <div
                    key={index}
                    className="border border-itin-sand-200 rounded-lg p-3 hover:border-itin-sand-400 transition-colors bg-accent-green-50"
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-xs text-accent-green-700 bg-accent-green-200 px-2 py-1 rounded">
                        Available
                      </div>
                    </div>
                  </div>
